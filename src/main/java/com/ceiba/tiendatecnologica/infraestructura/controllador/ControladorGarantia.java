...
public class ControladorGarantia {
	...
	public String generar(@PathVariable(name = "idProducto") String codigoProducto, @PathVariable(name ="nombreCliente") String nombreCliente, @RequestBody ComandoProducto comandoProducto) throws Exception {
		return this.manejadorGenerarGarantia.ejecutar(comandoProducto.getCodigo(),nombreCliente);
	}
